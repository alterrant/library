    ...
    <section className={classNames(styles.toolsWrapper, isOpenedInput && styles.openedInput)}>
      <div className={styles.booksUtils}>
        <BooksTool.SearchFilter
          ...
          changeHandler={(event) =>
            BooksToolModel.searchChangeHandler(
              event,
              setActivatedStatus,
              setStatusChangedText,
              dispatch
          ...
          openSearchBarHandler={() => BooksToolModel.openSearchBarHandler(setOpenedInputStatus)}
          closeSearchHandler={() => BooksToolModel.closeSearchHandler(setOpenedInputStatus)}
          isActivated={isActivated}
          isTextChanged={isTextChanged}
          isOpenedInput={isOpenedInput}
        />
        <BooksTool.RatingSort clickHandler={() => BooksToolModel.sortClickHandler(dispatch)} />
      </div>
      <ToggleCardsStyle
